...
// GetLADeleteGreenPinAllocationAPITarget provides a vegeta target for LA_GREENVN_DELETE_ALLOCATION api.
func GetLADeleteGreenPinAllocationAPITarget(act models.Act, urls []string, target *vegeta.Target) error {
